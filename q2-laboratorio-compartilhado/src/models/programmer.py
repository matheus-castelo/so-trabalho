...
class Programmer(threading.Thread):
    ...
    def acquire_resources(self):
        ...
        self.display_service.log(self.programmer_id, "Aguardando recursos...")
        self.resource_manager.acquire(self.programmer_id)
    ...
    def release_resources(self):
        self.resource_manager.release(self.programmer_id)
